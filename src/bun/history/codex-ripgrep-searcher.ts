// ============================================================
// Codex Ripgrep Searcher
//
// Full-text search over Codex rollout JSONL files using ripgrep.
// Mirrors PiRipgrepSearcher but targets `~/.codex/sessions/`.
// When scoping to a project, callers pass the set of date-nested
// subdirs produced by CodexHistoryMetadataCache.projectDirsForWorkspace.
// ============================================================
...
export class CodexRipgrepSearcher {
