// Espresso Libre theme for Monaco Editor
// Source: https://github.com/brijeshb42/monaco-themes/blob/master/themes/Espresso%20Libre.json
import type { editor } from "monaco-editor";

export const espressoLibreTheme: editor.IStandaloneThemeData = {
  base: "vs-dark",
  inherit: true,
  rules: [
